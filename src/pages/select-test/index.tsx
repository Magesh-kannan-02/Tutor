...
export const SelectTest = () => {
  ...
  return (
    <RootLayout>
      <div className="bg-background-200 w-full h-full py-4 px-3 overflow-hidden flex flex-col justify-between gap-5">
        ...
        <div className="flex flex-col gap-12">
          ...
          <div className="flex justify-start items-center w-full flex-col gap-10 flex-1">
            ...
            <div className="flex justify-center items-center w-full flex-col gap-5 max-h-[400px] overflow-y-scroll">
              {features.map((feature, i) => (
                <Featurecard
                  ...
                  className={cn(features.length > 4 && i === 0 && "mt-24")}
                />
              ))}
            </div>
          </div>
